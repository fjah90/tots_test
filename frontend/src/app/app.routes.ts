...
export const routes: Routes = [
  ...
  {
    path: 'spaces',
    loadChildren: () => import('./features/spaces/spaces.routes').then(m => m.SPACES_ROUTES),
  },
  ...
  // Mis Reservaciones - Requiere autenticación (User & Admin)
  {
    ...
    loadComponent: () =>
      import('./features/reservations/components/my-reservations/my-reservations.component').then(
  ...
  },
  {
    ...
    canActivate: [adminGuard],
    loadComponent: () =>
      import('./features/admin/components/admin-spaces/admin-spaces.component').then(
        m => m.AdminSpacesComponent
      ),
